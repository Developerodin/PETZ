      ...
      <section className="section">
            <div className="container">
              <div className="inner-container-center measure-wide reveal">
                ...
                <p>Early access to biomarker kits, the mobile app, and UAE clinical care quotes when we launch in your region.</p>
              </div>
              <form id="waitlistForm" className="form-card reveal" noValidate>
                <div className="form-grid">
                  ...
                  <div className="form-field">
                    ...
                    <input type="text" id="wlCountry" name="wlCountry" data-validate="required" data-label="Country" required />
                    <p className="field-error"></p>
                  </div>
                </div>
                ...
                <div className="form-success-panel" hidden>
                  <div className="form-success">
                    ...
                    <p>We'll email you when PETZ launches in your region. Meanwhile, try our free assessment.</p>
